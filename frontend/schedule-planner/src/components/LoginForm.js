...
function LoginForm() {
    return (
        <div className='w-1/2 bg-white px-10 py-5 rounded-3xl border-2 border-blue-800'>
            ...
            <div className='mt-6'>
                ...
                <div className='mt-6 flex flex-col gap-y-4'>
                    ...
                    <button className='flex py-2 rounded-xl border-2 border-blue-100 items-center justify-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all'>
                ...
                <div className='mt-6 flex justify-center items-center'>
                    ...
                    <button className='text-blue-800 text-medium ml-2'>Sign up</button>
                </div>
            </div>
        </div>
    )
